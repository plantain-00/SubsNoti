...
gulp.task('make', shell.task('tsc -p backends --pretty && mocha publish/backends/tests && tsc -p frontends --pretty && gulp tslint && gulp css && gulp js && gulp rev && gulp html && gulp doc && gulp dot && gulp icon'));
