...
export function bind(document: types.Document, handler: (request: libs.Request, response: libs.Response) => void, app: libs.Application) {
...
export function bindObsolete(document: types.ObsoleteDocument, handler: (request: libs.Request, response: libs.Response) => void, app: libs.Application) {
    app[document.method](document.url, (request: libs.Request, response: libs.Response) => {
